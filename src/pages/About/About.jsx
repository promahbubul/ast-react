    ...
    <div>
      <SinglePage pageTitle={"About A.S.T"}>
        <div className="flex flex-col gap-5 p-5">
          ...
          <Pera>
            5. *Returns and Refunds: <br />* - We stand behind the quality of
            our products. If you are not satisfied with your purchase for any
            reason, please contact us within 7 days of receiving your order to
            arrange for a return or exchange. <br /> - Returned items must be
            unused, unopened, and in their original packaging to be eligible for
            a refund or exchange. Customers may be responsible for return
            shipping costs unless the return is due to an error on our part.
          </Pera>
          <Pera>
            6. *Customer Satisfaction:* <br />- Your satisfaction is our top
            priority. If you have any questions, concerns, or feedback regarding
            our products or services, please don't hesitate to contact us. We
            are committed to addressing your inquiries promptly and courteously.
          </Pera>
          <Pera></Pera>
          <Pera>
            7. *Intellectual Property:* <br /> - All content and materials on
            our website, including but not limited to text, images, logos, and
            trademarks, are the intellectual property of AST. Unauthorized use
            or reproduction of any content is strictly prohibited.
          </Pera>
          <Pera>
            8. *Privacy Policy:* <br /> - We respect your privacy and are
            committed to protecting your personal information. Please refer to
            our Privacy Policy for details on how we collect, use, and safeguard
            your data.
          </Pera>
          <Pera>
            9. *Governing Law:* <br /> - These Terms and Conditions shall be
            governed by and construed in accordance with the laws of Bangladesh.
            Any disputes arising out of or related to these terms shall be
            resolved through amicable negotiations, and if necessary, through
            the appropriate legal channels in Bangladesh.
          </Pera>
          <Pera>
            10. *Updates and Amendments:* <br /> - We reserve the right to
            update or modify these Terms and Conditions at any time without
            prior notice. By continuing to use our website after any such
            changes, you accept and agree to the revised terms. It is your
