  ...
  return (
    <div className="font-kadwa bg-silver-100 py-10">
      <div className="text-center py-10 bg-[url('/images/aboutbg.png')]">
        <p className="text-2xl md:text-5xl drop-shadow-md  font-extrabold text-white">
          About A.S.T Distribution
        </p>
      </div>
      <div className="flex flex-col md:flex-row gap-4 md:gap-10 max-w-5xl mx-auto py-5 px-2 md:px-0 ">
        <Card
          title={" INCEPTION"}
